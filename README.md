...
Also, you need to change the path in push_relabel.cpp file but don't change the file name!. This cpp file will take about 10 seconds to 60 seconds to run your picture based on the size of your picture.
